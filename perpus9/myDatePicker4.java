...
public class myDatePicker4 extends JFrame{
	...
	myDatePicker4(){
		...
		this.setLocation(MyFrame.tglfield4.getLocationOnScreen().x,MyFrame.tglfield4.getLocationOnScreen().y);
		...
		OkBtn.addActionListener(e->{
			try {
				...
				MyFrame.tglfield4.setText(date+"");
