...
//		ImportButton();
	...
	void DaftarPinjamButton() {
		...
		dafpinbutton.setLocation(5,300);
	...
	void DaftarKunjunganButton() {
		...
		dafkunbutton.setLocation(5, 400);
	...
	void DashboardTemplate() {
		...
		dashboardtemplate.setBackground(tra);
		dashboardtemplate.setVisible(false);
	...
	void PinjamanTemplate() {
		...
		pinjamantemplate.setBackground(tra);
		pinjamantemplate.setVisible(false);
...
//				JOptionPane.showMessageDialog(null, "pinjaman "+tfield1.getText()+" telah disimpan");
	...
	void KunjunganTemplate() {
		...
		kunjungantemplate.setBackground(tra);
		kunjungantemplate.setVisible(false);
...
//				JOptionPane.showMessageDialog(null, "Kunjungan "+tfield3.getText()+" telah disimpan");
	...
	void StokTemplate() {
		...
		stoktemplate.setBackground(tra);
		stoktemplate.setVisible(false);
	...
	void StokBukuInput() {
		...
		upButton.addActionListener(e->{
			...
			if(tfield2.getText().equals("")) {
				...
				thn = Integer.parseInt(tfield2.getText());
			}
			...
			try {
				Koneksi();
				sql = "update stok_buku set kode_buku='"+kdbuku+"',penulis='"+tfield1.getText()+"',tahun='"+thn+"',judul='"+tfield3.getText()
