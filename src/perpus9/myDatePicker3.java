...
public class myDatePicker3 extends JFrame{
	...
	myDatePicker3(){
		...
		this.setLocation(MyFrame.tglfield3.getLocationOnScreen().x,MyFrame.tglfield3.getLocationOnScreen().y);
		...
		OkBtn.addActionListener(e->{
			try {
				...
				MyFrame.tglfield3.setText(date+"");
