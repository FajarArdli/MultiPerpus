...
public class myDatePicker5 extends JFrame{
	...
	myDatePicker5(){
		...
		this.setLocation(MyFrame.tglfield5.getLocationOnScreen().x,MyFrame.tglfield5.getLocationOnScreen().y);
		...
		for(int i=Calendar.getInstance().get(Calendar.YEAR) + 5; i >= Calendar.getInstance().get(Calendar.YEAR) - 5; i--) {
		    year_tmp.add(i+"");
		}
		...
		OkBtn.addActionListener(e->{
			...
			MyFrame.tglfield5.setText(date+"");
			this.dispose();
			}catch(Exception e1) {
