...
public class myDatePicker2 extends JFrame{
	...
	myDatePicker2(){
		...
		this.setLocation(MyFrame.tglfield2.getLocationOnScreen().x,MyFrame.tglfield2.getLocationOnScreen().y);
	...
	void Ok() {
		try {
			...
			MyFrame.tglfield2.setText(date+"");
